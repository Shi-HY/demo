 ...
 */
namespace Dompdf\src;

use DOMDocument;
use DOMNode;
use Dompdf\src\Adapter\CPDF;
use DOMXPath;
use Dompdf\src\Frame;
use Dompdf\src\Frame\Factory;
use Dompdf\src\Frame\FrameTree;

use Dompdf\lib\html5lib\HTML5_Tokenizer;
use Dompdf\lib\html5lib\HTML5_TreeBuilder;

use Dompdf\src\Image\Cache;
use Dompdf\src\Renderer\ListBullet;
use Dompdf\src\Renderer;
use Dompdf\src\Css\Stylesheet;
...
class Dompdf
{
    ...
    */
    ...
    public function loadHtml($str, $encoding = null)
    {
        ...
        set_error_handler(array("\\Dompdf\\src\\Helpers", "record_warnings"));
