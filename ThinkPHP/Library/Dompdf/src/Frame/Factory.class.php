...
use Dompdf\src\Css\Style;
use Dompdf\src\Dompdf;
use Dompdf\src\Exception;
use Dompdf\src\Frame;
use Dompdf\src\FrameDecorator\AbstractFrameDecorator;
use DOMXPath;
use Dompdf\src\FrameDecorator\Page as PageFrameDecorator;
use Dompdf\src\FrameReflower\Page as PageFrameReflower;
use Dompdf\src\Positioner\AbstractPositioner;
...
class Factory
{
    ...
    static function decorate_frame(Frame $frame, Dompdf $dompdf, Frame $root = null)
    {
        ...
        $decorator  = "Dompdf\\src\\FrameDecorator\\$decorator";
        $reflower   = "Dompdf\\src\\FrameReflower\\$reflower";
    ...
    protected static function getPositionerInstance($type)
    {
        if (!isset(self::$_positioners[$type])) {
            $class = '\\Dompdf\\src\\Positioner\\'.$type;
